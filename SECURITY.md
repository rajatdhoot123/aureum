...
3. Allow time for the maintainers to assess and address the vulnerability.
4. Once a fix is available, you may disclose the vulnerability publicly.
...
We keep dependencies up-to-date and review security advisories regularly. Please report any concerns via the channels above.